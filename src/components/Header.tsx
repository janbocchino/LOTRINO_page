...
const Header = () => {
  ...
  const navLinks = [
    ...
    { href: "/#about", labelKey: "mission" as const },
    { href: "/use-cases", labelKey: "useCases" as const },
        ...
        <div className="flex h-16 items-center justify-between md:h-20">
          ...
          <div className="flex items-center gap-1.5 md:hidden">
            <button
              ...
              className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg text-foreground outline-none ring-offset-2 ring-offset-neutral-950 transition-colors focus-visible:ring-2 focus-visible:ring-accent"
